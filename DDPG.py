...
class VizDoomGym(Env):
    def __init__(self, render=False):
        super().__init__()
        self.game = DoomGame()
        self.game.load_config('C:\\Users\\saimc\\Desktop\\MY PROJECT\\github\\vizdoom\\scenarios\\defend_the_center.cfg')
...
# DDPG model training with hyperparameter tuning and increased initial timestep length
model = DDPG('MlpPolicy', env, tensorboard_log=LOG_DIR, verbose=1, learning_rate=0.00001, gamma=0.95, buffer_size=int(1e6),
             learning_starts=1000, train_freq=1, gradient_steps=1, batch_size=64, tau=0.001,
